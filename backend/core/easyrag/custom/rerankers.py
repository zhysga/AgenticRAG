...
from llama_index.core.schema import MetadataMode, NodeWithScore, QueryBundle, BaseNode
...
class SentenceTransformerRerank(BaseNodePostprocessor):
    ...
    __pydantic_private__: dict = {}  # 添加缺失的属性
    ...
    def __init__(
        ...
        # CrossEncoder 不支持 trust_remote_code 参数，移除该参数
        try:
